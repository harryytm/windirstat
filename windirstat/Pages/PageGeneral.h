...
protected:
    ...
    int m_contextMenuIntegration = FALSE;
    ...
    static bool IsContextMenuRegistered(bool allUsers = true);
    static bool SetContextMenuRegistration(bool enable, bool allUsers = true);
